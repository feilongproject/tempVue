        ...
        <div class="content-init">
            <el-row>
                <el-col :span="8"><div class="grid-content">
                    ...
                    <span style="font-style: italic;">{{ tierDataDisplay[0]?.Hard || 'N/A' }} {{ tierDataDisplay[0]?.BattleTime || 'N/A' }}</span>
                </div></el-col>
                <el-col :span="8"><div class="grid-content">
                    <img src="../assets/tier3.webp" class="tier-icon" alt="二档"/>
                    <span style="font-weight: bold;">{{ tierDataDisplay[1]?.BestRankingPoint || 'N/A' }}</span>
                    <span style="font-style: italic;">{{ tierDataDisplay[1]?.Hard || 'N/A' }} {{ tierDataDisplay[1]?.BattleTime || 'N/A' }}</span>
                </div></el-col>
                <el-col :span="8"><div class="grid-content">
                    <img src="../assets/tier2.webp" class="tier-icon" alt="三档"/>
                    <span style="font-weight: bold;">{{ tierDataDisplay[2]?.BestRankingPoint || 'N/A' }}</span>
                    <span style="font-style: italic;">{{ tierDataDisplay[2]?.Hard || 'N/A' }} {{ tierDataDisplay[2]?.BattleTime || 'N/A' }}</span>
                </div></el-col>
            </el-row>
        </div>
...
.content-header{
    ...
    color:white;
    display: flex; /* 使 div 成为 flexbox 容器 */
